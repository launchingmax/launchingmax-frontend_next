...
const buttonVariants = cva(
  "inline-flex items-center justify-center disabled:pointer-events-none ", //focus:!ring-2 focus:!outline-none focus:!ring-offset-2
  {
    variants: {
      variant: {
        primary:
          "bg-button-primary-bg text-button-primary-fg hover:bg-button-primary-bg_hover hover:text-button-primary-fg_hover focus:bg-button-primary-bg focus:text-button-primary-fg  disabled:text-fg-disabled disabled:!border-disabled-subtle disabled:bg-disabled disabled:!shadow-xs",
        secondaryGray:
      ...
      size: {
        ...
        "2xl": "rounded-lg px-[1.375rem] py-xl gap-x-[0.625rem] text-lg font-semibold",
